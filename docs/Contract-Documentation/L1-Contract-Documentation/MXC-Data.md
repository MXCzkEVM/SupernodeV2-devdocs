...
struct Config {
  ...
  uint64 emptyBlockInterval;
  uint256 proposeBlockDeposit;
...
```solidity
struct Evidence {
  struct MXCData.BlockMetadata meta;
...
struct State {
  ...
  mapping(uint256 => struct MXCData.ProposedBlock) proposedBlocks;
  mapping(uint256 => mapping(bytes32 => struct MXCData.ForkChoice)) forkChoices;
